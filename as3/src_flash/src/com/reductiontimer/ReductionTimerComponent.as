package com.reductiontimer
{
    ...
    import com.reductiontimer.config.Config;
    import com.reductiontimer.reduction.ReductionPanel;

    public class ReductionTimerComponent extends ReductionTimerDisplayable
    {
        ...
        public function ReductionTimerComponent()
        {
            super();
            _config = new Config();
