package com.reductiontimer
{
    ...
    public class ReductionTimerInjector extends AbstractView
    {
        public var py_onDragEnd:Function = null;

        private var _component:ReductionTimerComponent = null;

        public function ReductionTimerInjector()
        {
            super();
        }
        ...
        override protected function onPopulate():void
        {
            ...
            while (idx < mainViewContainer.numChildren)
            {
                ...
                if (view)
                {
                    _component = new ReductionTimerComponent();
                    _component.componentName = "ReductionTimerComponent";
